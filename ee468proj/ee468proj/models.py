...
class Course(models.Model):
    ...
    class Meta:
        ...
        db_table = 'Course'
    def __repr__(self):
       return "Dept: "+self.course_id+","+self.title+","+str(self.dept_name)+","+str(self.credits)
'''
...
class Section(models.Model):
    ...
    sec_id = models.CharField(max_length=4, primary_key=True)
    ...
    # def __repr__(self):
    #    return "Section: "+self.course.course_id+","+self.sec_id+","+str(self.semester)+","+str(self.year)+","+self.building+","+self.room+","+str(self.capacity)
...
class Department(models.Model):
    ...
    def __str__(self):
        return "Department: " + self.dept_name
